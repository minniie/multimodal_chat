...
python3 run_image_retriever.py \
    ...
    --encoding_path /mnt/16tb/minyoung/checkpoints/photochat/image_retriever/vit_base_bert_base/checkpoint-6430/image_encodings.pt \
    --retriever_image_encoder_path google/vit-base-patch16-224 \
    --retriever_text_encoder_path bert-base-uncased \
    --retriever_finetuned_path /mnt/16tb/minyoung/checkpoints/photochat/image_retriever/vit_base_bert_base/checkpoint-6430 \
